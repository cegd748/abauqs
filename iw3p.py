...
for i, num in enumerate(shearkey_nums):
    ...
    step1 = MyStep(assembly1, step_type=StepType.STATIC_STEP, maxInc=0.02, initInc=0.005, output_increment=0.01)
    ...
    myPartitionConcrete = PartitionConcrete(itube, column, concrete, more_partition=True)
    MeshConcrete(itube, column, concrete, myPartitionConcrete, global_size=6, innner_size=12, radius1_outside_elements=1,
                 radius1_inside_elements=4, radius2_elements=3, shearkey_elements=6, edge1_elements=2)
